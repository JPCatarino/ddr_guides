function [medias_PL, temp_PL , medias_APD, temp_APD , medias_MDP, temp_MDP , medias_TT, temp_TT] =  ... 
    runSimulator3(n_times, alfa, lambda, C, f, P, b)
...
for it = 1:n_times
     [results_PL(it),results_APD(it),results_MDP(it), results_TT(it)] =  Simulator3(lambda, C, f, P, b);
end
